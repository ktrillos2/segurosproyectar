              ...
              <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
                  ...
                  >
                    ...
                    <button type="submit" className="w-full bg-[#1e3450] hover:bg-[#162539] text-white font-bold py-4 px-6 rounded-lg transition-colors shadow-sm text-[15px] tracking-wide">
                      ENVIAR SOLICITUD
                    </button>
                  </form>
                </div>
